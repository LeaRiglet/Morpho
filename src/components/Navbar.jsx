  ...
  return (
    <header className="sticky top-0 z-50 bg-gray-200 text-gray-800 px-8 py-5 flex justify-between items-center shadow-neumorphism">
      ...
      <nav className="flex space-x-5 font-medium">
        <Link className="hover:text-blue-600" to="/">Accueil</Link>
        <Link className="hover:text-blue-600" to="/products">Produits</Link>
        <Link className="hover:text-blue-600" to="/devenir-imprimeur">Imprimeur ?</Link>
