    ...
    <main className="max-w-5xl mx-auto mt-10 p-6 bg-gray-200 rounded-3xl shadow-neumorphism">
      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
        {products.map((product, idx) => (
          <div
            className="bg-gray-200 rounded-3xl shadow-neumorphism p-6 flex flex-col items-center transition-transform hover:-translate-y-1 hover:shadow-neumorphism-btn"
            key={idx}
          >
