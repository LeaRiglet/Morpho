...
function Home() {
  return (
    <>
      <div className="py-16 text-center bg-gray-200 shadow-neumorphism">
      ...
      <section className="py-10 max-w-2xl mx-auto bg-gray-200 rounded-3xl shadow-neumorphism" id="mission">
      ...
      <section className="py-10 bg-gray-200 rounded-3xl shadow-neumorphism" id="roi">
        <ROIChart />
      </section>
