...
function Home() {
  return (
    <>
      <div className="bg-gray-200 shadow-neumorphism py-16 text-center rounded-3xl mx-4">
        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          <div className="rounded-3xl shadow-neumorphism overflow-hidden bg-gray-200 flex flex-col">
            ...
            <div className="p-4 flex flex-col flex-1">
              ...
              <button onClick={triggerConfetti} className="mt-auto px-4 py-2 rounded-3xl bg-gray-200 text-gray-800 font-semibold shadow-neumorphism-btn hover:shadow-neumorphism-btn-hover">Ajouter au panier</button>
            </div>
          </div>
      ...
      <section className="py-10 max-w-2xl mx-auto bg-gray-200 rounded-3xl shadow-neumorphism p-6" id="mission">
